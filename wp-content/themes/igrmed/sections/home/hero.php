                ...
                <div class="hero__middle hero__cards-swiper js-hero-swiper">
                    <div class="hero__cards-row swiper-wrapper">
                        ...
                        <div class="hero__card-header">
                            <?php if ($promo_title !== ''): ?>
                                <h3 class="hero__card-title hero__card-title--promo"><?php echo wp_kses_post($promo_title); ?>
                                </h3>
                            <?php endif; ?>
                                ...
                                <div class="hero__card-meta-row">
                                    ...
                                    <?php if ($article_date !== ''): ?>
                                        <span class="hero__card-meta hero__card-meta--date">
                                            <span class="hero__card-meta-icon hero__card-meta-icon--calendar" aria-hidden="true">
